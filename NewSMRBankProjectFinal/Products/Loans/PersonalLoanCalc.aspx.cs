...
{
    public partial class PersonalLoanCalc : System.Web.UI.Page
    {
        double e1 = 0;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if ((RadioButton1.Checked == true) && (Convert.ToInt32(TextBox8.Text) < 12000))
            {
                //Label1.Text="Sorry......You are not eligible for loan.Requied salary more than 12k for CSA A/C Holder";
                Response.Write("<script>alert('Sorry......You are not eligible for loan.Requied salary more than 12k for SMR A/C Holder')</script>");
                Amount.Text = "";
                Rate.Text = "";
                PF.Text = "";
                EMI.Text = "";
            }
            if ((RadioButton2.Checked == true) && (Convert.ToInt32(TextBox8.Text) < 15000))
            {
                Response.Write("<script>alert('Sorry......You are not eligible for loan.Requied salary more than 15k for Non-A/C Holder')</script>");
            ...
            //Rate of interest
            if ((Convert.ToInt32(TextBox8.Text) > 12000) && (Convert.ToInt32(TextBox8.Text) < 20000))
            {
                Rate.Text = "21.00";
            }
            ...
            if ((Convert.ToInt32(TextBox8.Text) >= 75000) && (Convert.ToInt32(TextBox8.Text) < 100000))
            {
                Rate.Text = "15.00";
            }
            if ((Convert.ToInt32(TextBox8.Text) >= 100000))
            {
            ...
            if ((DropDownList4.SelectedValue == "Proprietorship Firm") || (DropDownList4.SelectedValue == "Partnership Firm"))
            { Response.Write("<script>alert('Sorry......You are not eligible for loan')</script>"); }
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            double r1 = Convert.ToDouble(Rate.Text);
            double p = Convert.ToDouble(Amount.Text);
