<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Autoloancalc.aspx.cs" Inherits="NewSMRBankProjectFinal.Products.Loans.Autoloancalc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<div class="AutoFormContent">
        <h1>Auto Loan Eligibility Calculator</h1><div style=" border-bottom: 1px dotted #ddd;"></div>
        <div class="AutoFormHolder">
            <table cellpadding="8">
                <tbody>
                    <tr>
 ...
 <asp:ListItem>	Audi Car Models	</asp:ListItem>
 <asp:ListItem>	BMW Car Models	</asp:ListItem>
 <asp:ListItem>	Bugatti Car Models	</asp:ListItem>
 <asp:ListItem>	Cadillac Car Models 	</asp:ListItem>
 <asp:ListItem>	Chevrolet Car Models 	</asp:ListItem>
 <asp:ListItem>	Citroen Car Models 	</asp:ListItem>
 <asp:ListItem>	Dodge Car Models    	</asp:ListItem>
 <asp:ListItem>	Fiat Car Models 	</asp:ListItem>
 <asp:ListItem>	Ferrari Car Models 	</asp:ListItem>
 <asp:ListItem>	Ford Car Models 	</asp:ListItem>
 <asp:ListItem>	Honda Car Models 	</asp:ListItem>
 <asp:ListItem>	Hyundai Car Models	</asp:ListItem>
 <asp:ListItem>	Jaguar Car Models 	</asp:ListItem>
 <asp:ListItem>	Kia Car Models 	</asp:ListItem>
 <asp:ListItem>	Lamborghini Car Models	</asp:ListItem>
 <asp:ListItem>	Mazda Car Models	</asp:ListItem>
 <asp:ListItem>	Mini Car Models 	</asp:ListItem>
 <asp:ListItem>	Mitsubishi Car Models	</asp:ListItem>
 <asp:ListItem>	Morgan Car Models 	</asp:ListItem>
 <asp:ListItem>	Nissan Car Models 	</asp:ListItem>
 <asp:ListItem>	Opel Car Models 	</asp:ListItem>
 <asp:ListItem>	Peugeot Car Models 	</asp:ListItem>
 <asp:ListItem>	Porsche Car Models 	</asp:ListItem>
 <asp:ListItem>	Renault Car Models	</asp:ListItem>
 <asp:ListItem>	Skoda Car Models 	</asp:ListItem>
 <asp:ListItem>	Subaru Car Models 	</asp:ListItem>
 <asp:ListItem>	Suzuki Car Models 	</asp:ListItem>
 <asp:ListItem>	Toyota Car Models 	</asp:ListItem>
 <asp:ListItem>	Volkswagen Car Models 	</asp:ListItem>
 <asp:ListItem>	Volvo Car Models	</asp:ListItem>

        </asp:DropDownList>
        <asp:RequiredFieldValidator runat="server" ForeColor="#CC3300" 
            ControlToValidate="DropDownList9" ErrorMessage="** Select Your Car Model" 
            ID="RequiredFieldValidator14"></asp:RequiredFieldValidator>
        </td>
                    </tr>
                    <tr>
       <td>Type of Company</td>
       <td> <asp:DropDownList runat="server" ID="DropDownList4" AutoPostBack="True">
            <asp:ListItem></asp:ListItem>
        ...
        <asp:RequiredFieldValidator runat="server" ForeColor="#CC3300" 
            ...
            ID="RequiredFieldValidator9"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        <td>Company Name</td>
       <td> <asp:DropDownList runat="server" AutoPostBack="True" ID="DropDownList3" Height="16px" 
                    Width="168px">
            <asp:ListItem></asp:ListItem>
       ...
       <td>Salary A/C in</td>
              <td>   <asp:RadioButton runat="server" Text="SMR Bank" ID="RadioButton1" 
                     GroupName="SALARY" />
                  
      
        
                            <asp:RadioButton runat="server" Text="Other Bank" 
            ID="RadioButton2" GroupName="SALARY"></asp:RadioButton></td>
            </tr>
            <tr>
       <td>Monthly Net Salary</td>
                                     <td> <asp:TextBox runat="server" ID="TextBox8" 
       ...
       <tr>
       <td>Total Experiance in Current Company</td>
       <td> <asp:DropDownList runat="server" ID="DropDownList7" AutoPostBack="True">
            <asp:ListItem></asp:ListItem>
       ...
       <td> <asp:DropDownList runat="server" ID="DropDownList8" AutoPostBack="True">
            <asp:ListItem></asp:ListItem>
            <asp:ListItem Value="0">Less Than 6 Months </asp:ListItem>
            <asp:ListItem Value="1">6 to 11 Months</asp:ListItem>
            <asp:ListItem Value="2">1 Years</asp:ListItem>
       ...
       <td>
        ...
        <asp:RequiredFieldValidator runat="server" ForeColor="#CC3300" 
            ...
            ID="RequiredFieldValidator5"></asp:RequiredFieldValidator>
                    ...
                    <tr>
       <td>Total yrs on Current Address</td>
    
       <td> <asp:DropDownList runat="server" ID="DropDownList5" AutoPostBack="True">
            <asp:ListItem></asp:ListItem>
            <asp:ListItem Value="0">Less Than 6 Months </asp:ListItem>
            <asp:ListItem Value="1">6 to 11 Months</asp:ListItem>
            <asp:ListItem Value="2">1 Years</asp:ListItem>
        ...
        <asp:RequiredFieldValidator runat="server" ForeColor="#CC3300" 
            ...
            ID="RequiredFieldValidator6"></asp:RequiredFieldValidator>
                    ...
                    <tr>
       <td>Total yrs in current city</td>
        <td><asp:DropDownList runat="server" ID="DropDownList6" 
        ...
        <asp:RequiredFieldValidator runat="server" ForeColor="#CC3300" 
            ...
            ID="RequiredFieldValidator7"></asp:RequiredFieldValidator>
                    ...
                    <tr>
       <td>Obligation of Loans<br />&nbsp;(If any loan is going on)</td>
    ...
    <asp:Panel ID="Panel1" runat="server" BackColor="#333399" >
                ...
                <table cellpadding="8">
                    <tbody>
                        <tr>
                            <td colspan="2"><h3>Maximum Eligibility Calculator</h3></td>
                        </tr>
                        <tr>
                            <td>
           ...
           <td> <asp:Label ID="Amount" runat="server"></asp:Label></td>
                            ...
                            <td>
            <asp:Label ID="Label5" runat="server" Text="Tenure"></asp:Label>
            </td>
           <td> <asp:Label ID="months" runat="server"></asp:Label>
          </td>
          </tr>
               <tr>
                            <td>  <asp:Label ID="Label1" runat="server" Height="25px"  Width="120px">Rate of Interest</asp:Label></td>
                <td>
                <asp:Label ID="Rate" runat="server"></asp:Label>
            </td>
            </tr><tr><td>
            <asp:Label ID="Label3" runat="server" Text="EMI(Monthly instalment)"></asp:Label>
            </td>
            <td><asp:Label ID="EMI" runat="server"></asp:Label></td></tr>
            <tr>
          <td> <asp:Label ID="Label4" runat="server" Text="Processing Fees"></asp:Label></td> 
           <td>
            <asp:Label ID="PF" runat="server" style="font-weight: 700"></asp:Label>
            </td>
           </tr>
                ...
                <div class="TableHolder">
                <asp:Panel ID="Panel2" runat="server" BackColor="#333399" >
                
                <table cellpadding="8">
                    <tbody>
                        <tr>
                            <td colspan="2"><h3>Personal Loan Calculator</h3></td>
                        </tr>
                       
       <tr>   <td> <asp:Label ID="Label6" runat="server" Text="Loan Amount"></asp:Label></td>
          <td>  
              <asp:TextBox ID="loanamt" runat="server"></asp:TextBox>
              </td></tr>
              <tr>
                  <td>
                      <asp:Label ID="Label8" runat="server" Text="Tenure(in months)"></asp:Label>
                  </td>
                  <td>
                      <asp:DropDownList ID="tenor" runat="server" Height="19px" Width="66px">
                          <asp:ListItem></asp:ListItem>
              ...
              <tr>
                  <td>
                      <asp:Button ID="Button2" runat="server" onclick="Button2_Click" Text="Show EMI AND PF" />
                  </td>
              </tr>
              <tr>
                  <td>
                      <asp:Label ID="Label12" runat="server" Text="EMI(Monthly instalment)"></asp:Label>
                  </td>
                  <td>
                      <asp:Label ID="emi1" runat="server"></asp:Label>
                  </td>
              </tr>
              <tr>
                  <td>
                      <asp:Label ID="Label14" runat="server" Text="Processing Fees"></asp:Label>
                  </td>
                  <td>
                      <asp:Label ID="pf1" runat="server"></asp:Label>
                  </td>
              </tr>
