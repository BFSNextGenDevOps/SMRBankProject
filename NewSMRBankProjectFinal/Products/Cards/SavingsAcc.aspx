<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SavingsAcc.aspx.cs" Inherits="NewSMRBankProjectFinal.Products.Cards.Savingsacc" %>
...
<tr>
    <td bgcolor="#0066CC" colspan="2"> <img id="Img1" alt="SMR Bank" src="~/images/SMR-logo4.png" border="0" runat="server"  /></td></tr>
<tr>
<td class="style6" colspan="2" align="center">
    <asp:Label ID="Label13" runat="server"  
        Text="Thank you for your interest in SMR Bank Card . Please fill up the details below and we will get in touch with you shortly. " 
        BackColor="#666666" ForeColor="White" Font-Bold="True" Font-Names="Verdana" 
...
<td style="width: 250px">
    <asp:DropDownList ID="DropDownList1" runat="server">
      ...
      <asp:Label ID="Label7" runat="server" Text="Saving Account" Visible="False"></asp:Label>
</td></tr>
<tr>
<td class="style4">
...
<td style="width: 250px">
  <asp:DropDownList ID="DropDownList2" runat="server" Height="20px" Width="250px" 
                                AutoPostBack="True">
...
<tr>
<td>
    <asp:Label ID="Label11" runat="server" Text="Residence No."></asp:Label>
</td>
<td>
...
<td class="style5">
    ...
    <tr>
    <td>
    <asp:Label ID="Label17" runat="server" Text="Label">Residence Type</asp:Label></td>
                         ...
                         <tr><td><asp:Label ID="Label18" runat="server" Text="Label">
                         ...
                         <tr>
                         <td>
                         <asp:Label ID="Label19" runat="server" Text="Label">Total yrs in current city</asp:Label>
                         ...
                         <td>
                           <asp:DropDownList ID="DropDownList6" runat="server">
                            ...
                            <tr>
                            <td>
                            <asp:Label ID="Label20" runat="server" Text="Label">Type of Company</asp:Label>
                          </td>
                          <td>
                            ...
                            <tr>
                            <td><asp:Label ID="Label22" runat="server" Text="Label">
  ...
  <asp:ListItem>	Zylog Systems Ltd.	</asp:ListItem>
                            ...
                            Monthly Net Salary</asp:Label></td>
                            <td>
                          <asp:TextBox ID="TextBox10" runat="server" style="margin-bottom: 0px"></asp:TextBox></td></tr>
    ...
    <td colspan="2">
        <asp:CheckBox ID="CheckBox1" runat="server" 
            ...
            Text=" I authorize SMR Bank &amp; its representatives to call me or SMS me with reference to my application. This consent will override any registration for DNC / NDNC. " 
            Checked="True" />
    </td></tr>
    <tr>
    <td align="center" colspan="2">
        <asp:Button ID="Button1" runat="server" Text="Submit" BackColor="#0033CC" 
    ...
    <br />
     ...
     <div id="Footer">
     <hr />
            <p class="CopyRight">&copy 2014 <a id="A1" href="~/Default.aspx" runat="server">SMR Bank</a> Ltd. All rights reserved.</p>
        </div>
    </form>
</body>
</html>
